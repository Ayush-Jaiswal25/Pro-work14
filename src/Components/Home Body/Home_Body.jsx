    ...
    <div  className='Home_Body'>
      <div className="box1" >
        ...
        <div className="sub-box1">
          ...
          <Link onClick={heroScrollx} to='/prowork/services'><button data-cursor="-hidden" className='sub-box1-right-btn'>Click Here</button></Link>
      ...
      <div className="workcatagory">
        ...
        <div className="hero-lower5">
            <a href="/prowork/services/electrician" className="box"><img src={heroLower_Electrician}/></a>
            <a href="/prowork/services/priest" className="box"><img src={heroLower_Priest}/></a>
            <a href="/prowork/services/cook" className="box"><img src={heroLower_Cook}/></a>
            <a href="/prowork/services/tailor" className="box"><img src={heroLower_Talior}/></a>
            <a href="/prowork/services/contractor" className="box"><img src={heroLower_Contractor}/></a>
        </div>
        <div className="hero-lower5">
            <a href="/prowork/services/electrician" className="box"><img src={heroLower_Electrician}/></a>
            <a href="/prowork/services/priest" className="box"><img src={heroLower_Priest}/></a>
